        ...
        logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* SessionManagement sessionManagement=new SessionManagement(getContext());
                ...
                mEditor.clear();
                mEditor.apply();
                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.Linear,new Login_page()).commit();
...
//                getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.Linear, fragment).commit();
//            }
        });
                return view;
    }
